window.customResources = [
  ...
  {
    competencyKey: "digitalResponsibility",
    level: "knowledge",
  ...
  {
    competencyKey: "learningAdapting",
    level: "knowledge",
...
console.log("resources-fr.js executed. window.customResources (length):", (window.customResources || []).length);
